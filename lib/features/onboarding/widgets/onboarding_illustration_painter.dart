...
/// Decorative outline-only skyline for Onboarding Screen 2: a couple of
...
class OnboardingIllustrationPainter extends CustomPainter {
  OnboardingIllustrationPainter({required this.progress});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ...
      ..color = OnboardingColors.primaryBlue.withValues(alpha: 0.16 * opacity);
